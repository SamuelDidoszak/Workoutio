...
public class GridLayoutManagerHorizontalSwipe extends GridLayoutManager implements HorizontalSwipe {
    ...
    public GridLayoutManagerHorizontalSwipe(Context context, int spanCount, int orientation, boolean reverseLayout) {
